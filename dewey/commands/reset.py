...
class Command(DeweyCommand):
    ...
    def run_command(self, *args, **kwargs):
        ...
        subprocess.call("ln -s package.json app/package.json", shell=True)
        subprocess.call("rm -rf node_modules", cwd="app/native/ionic", shell=True)
        subprocess.call("ln -s node_modules app/native/ionic/node_modules", shell=True)
        subprocess.call("rm package.json", cwd="app/native/ionic", shell=True)
        subprocess.call("ln -s package.json app/native/ionic/package.json", shell=True)
        ...
        subprocess.call("ln -s bower_components app/bower_components", shell=True)
        subprocess.call("rm app/bower.json", shell=True)
        subprocess.call("ln -s bower.json app/bower.json", shell=True)
        subprocess.call("rm -rf bower_components", cwd="app/native/ionic", shell=True)
        subprocess.call("ln -s bower_components app/native/ionic/bower_components", shell=True)
        subprocess.call("rm bower.json", cwd="app/native/ionic", shell=True)
        subprocess.call("ln -s bower.json app/native/ionic/bower.json", shell=True)
